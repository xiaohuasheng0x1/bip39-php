...
use BIP\Exception\MnemonicException;
use BIP\Exception\WordListException;
use BIP\WordList;
...
class BIP39
{
     ...
     * @param string|\BIP\WordList $lang
     * @return \BIP\Mnemonic
     * @throws \BIP\Exception\MnemonicException
     * @throws \BIP\Exception\WordListException
     */
     ...
     * @param \BIP\WordList $wordsList
     * @throws \BIP\Exception\MnemonicException
     */
    public function __construct(public int $wordsCount, public WordList $wordsList)
    {
